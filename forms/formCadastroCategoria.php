...
<body>
	...
	<table id="formularioupload">	
		<tr>
			<div class="novocad">
				<td>
				<form method="post" enctype="multipart/form-data" action="../actions/cadastraCategoria.php" onsubmit="return validaCadastroCategoria()">
				   <table class="recuo">
						<tr>
						...
						<tr>
					   	...
					   	<tr>
							...
							<td><input type="text" name="txtNome" id="txtNome" size="50px" /></td>
					   </tr>
