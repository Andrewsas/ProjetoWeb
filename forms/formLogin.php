...
<body>
	<table id="formulario">	
		<tr>
			<div class="novocad">
				<td>
					<form method="post" action="../actions/cadastraCliente.php" novalidate onsubmit="return js/validaCadastroUsuario()">
						<table class="recuo">
			...
			<div class="login">				
				<td>
					<form  method="post" action="../actions/validaLogin.php" onsubmit="return ../js/validaLogin()">	
						<table class="recuo" >
							...
							<tr>
								<td>
									...
									<input type="email" size="40" required id="txtEmailLogin" name="txtEmailLogin">
								</td>
							</tr>
							<tr>
								<td>
									<label>Senha*</label><br>
									<input type="password" size="40" required id="txtSenhaLogin" name="txtSenhaLogin">
								</td>
							</tr>
							<tr>
